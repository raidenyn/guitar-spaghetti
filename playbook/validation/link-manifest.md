...
| INT-003 | [START_HERE session guidance](../START_HERE.md#during-and-after-a-session) | [Exact SESSION_HANDOFF schema](../PROGRESS_STATE.template.md#session_handoff) | Transfer observed state without hidden chat history. | Playbook 1.0 | 2026-07-25 | PASS |
